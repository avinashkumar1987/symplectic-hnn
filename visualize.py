...
# Conditional check for __main__ and if not running in Jupyter Notebook
if __name__ == "__main__" and not ('ipykernel_launcher' in sys.argv[0]):
    import argparse
    parser = argparse.ArgumentParser()
    # Add argparse arguments if needed
    ...
    # Use args as needed in the script
